...
\hypertarget{when-do-we-need-model-explainers}{%
\section{When do we need model
explainers?}\label{when-do-we-need-model-explainers}}
...
## ok         537 1244      440   0.4398919
## promoted   202  384     2185   0.2114760
\end{verbatim}
...
## Confusion matrix:
##          fired   ok promoted class.error
## fired     2272  389      194   0.2042032
## ok         532 1242      447   0.4407924
## promoted   210  387     2174   0.2154457
\end{verbatim}
...
## Predicted value: 0.818000, Average prediction: 0.375439 (diff = 0.442561) Predicted value: 0.182000, Average prediction: 0.274985 (diff = -0.092985) Predicted value: 0.000000, Average prediction: 0.349576 (diff = -0.349576)
## 
## Analysed predictor: 
...
## 1     gender fired  0.08802 0.09030226   gender=male
## 2        age fired  0.16662 0.09677145      age=57.7
## 3      hours fired  0.30782 0.11146280    hours=42.3
## 4 evaluation fired  0.05994 0.02333192  evaluation=2
## 5     salary fired -0.16144 0.06225908      salary=2
...
## Confusion matrix:
##          fired   ok promoted class.error
## fired     2281  376      198   0.2010508
## ok         537 1246      438   0.4389914
## promoted   204  395     2172   0.2161674
\end{verbatim}
...
## 1 classification    1    fired      0.822 0.1243753       0.2577293
## 2 classification    1    fired      0.822 0.1243753       0.2577293
## 3 classification    1    fired      0.822 0.1243753       0.2577293
## 4 classification    1       ok      0.178 0.1312786       0.1917093
## 5 classification    1       ok      0.178 0.1312786       0.1917093
## 6 classification    1       ok      0.178 0.1312786       0.1917093
## 7 classification    1 promoted      0.000 0.2813100       0.5259333
## 8 classification    1 promoted      0.000 0.2813100       0.5259333
## 9 classification    1 promoted      0.000 0.2813100       0.5259333
##   model_prediction    feature feature_value feature_weight
## 1        0.6320203        age          57.7    0.012187234
## 2        0.6320203      hours          42.3    0.254980412
## 3        0.6320203 evaluation           2.0    0.107123343
## 4        0.4586087        age          57.7   -0.013571681
## 5        0.4586087 evaluation           2.0    0.206925712
## 6        0.4586087     salary           2.0    0.073545355
## 7        0.0077570     gender           2.0   -0.008969469
## 8        0.0077570 evaluation           2.0   -0.313247831
## 9        0.0077570      hours          42.3   -0.195959033
##           feature_desc                      data          prediction
## 1           50.0 < age 2.0, 57.7, 42.3, 2.0, 2.0 0.822, 0.178, 0.000
## 2 37.6 < hours <= 46.3 2.0, 57.7, 42.3, 2.0, 2.0 0.822, 0.178, 0.000
## 3      evaluation <= 3 2.0, 57.7, 42.3, 2.0, 2.0 0.822, 0.178, 0.000
## 4           50.0 < age 2.0, 57.7, 42.3, 2.0, 2.0 0.822, 0.178, 0.000
## 5      evaluation <= 3 2.0, 57.7, 42.3, 2.0, 2.0 0.822, 0.178, 0.000
## 6      1 < salary <= 2 2.0, 57.7, 42.3, 2.0, 2.0 0.822, 0.178, 0.000
## 7        gender = male 2.0, 57.7, 42.3, 2.0, 2.0 0.822, 0.178, 0.000
## 8      evaluation <= 3 2.0, 57.7, 42.3, 2.0, 2.0 0.822, 0.178, 0.000
## 9 37.6 < hours <= 46.3 2.0, 57.7, 42.3, 2.0, 2.0 0.822, 0.178, 0.000
\end{verbatim}
...
## 1  0.060249245       1.0  0.06024925       male gender=male   gender=male
## 2  0.005037601      57.7  0.29066958       57.7         age      age=57.7
## 3 -0.090384660      42.3 -3.82327111       42.3       hours    hours=42.3
## 4 -0.503347606       2.0 -1.00669521          2  evaluation  evaluation=2
## 5 -0.029501169       2.0 -0.05900234          2      salary      salary=2
## 6 -0.020607582       1.0 -0.02060758       male gender=male   gender=male
##   .class
## 1  fired
## 2  fired
## 3  fired
...
## 
##           Mean of squared residuals: 484581.2
##                     % Var explained: 41
\end{verbatim}
...
## 1                1920        5     142     8 3100.458 construction.year
## 1.1              1921        5     142     8 3129.670 construction.year
## 1.2              1922        5     142     8 3119.952 construction.year
## 1.3              1923        5     142     8 3090.484 construction.year
## 1.4              1923        5     142     8 3090.484 construction.year
## 1.5              1924        5     142     8 3099.736 construction.year
##     _ids_      _label_
## 1       1 randomForest
## 1.1     1 randomForest
## 1.2     1 randomForest
...
## 1              1965        5     142     8 2310.334 randomForest
\end{verbatim}
...
## 2           surface     1     683.5261
## 4          no.rooms     1     417.6918
## 3             floor     1     333.7353
## 1 construction.year     1     265.0362
\end{verbatim}
