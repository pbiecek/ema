...
\item
  Subsection \emph{The Algorithms}, that shows mathematical or
...
\section{White-box models vs Black-box
...
\chapter{Sequential Additive Attributions}\label{breakDown}}
...
## fired     2272  380      203   0.2042032
## ok         536 1242      443   0.4407924
## promoted   201  384     2186   0.2111151
\end{verbatim}
...
\chapter{Sequential attributions with
...
## Confusion matrix:
##          fired   ok promoted class.error
## fired     2267  393      195   0.2059545
## ok         532 1248      441   0.4380910
## promoted   198  387     2186   0.2111151
\end{verbatim}
...
## * hours = 42                  0.237
## * salary = 2                 -0.205
## * age:gender = 58:male        0.400
## * evaluation = 2             -0.015
## final_prognosis               0.792
## baseline:  0
\end{verbatim}
...
\hypertarget{shapley}{%
\chapter{Average Additive Attributions}\label{shapley}}
...
## Predicted value: 0.756000, Average prediction: 0.375563 (diff = 0.380437) Predicted value: 0.240000, Average prediction: 0.275009 (diff = -0.035009) Predicted value: 0.004000, Average prediction: 0.349428 (diff = -0.345428)
## 
## Analysed predictor: 
...
## 1     gender fired  0.10788 0.07415845   gender=male
## 2        age fired  0.13618 0.08299459      age=57.7
## 3      hours fired  0.26922 0.12042803    hours=42.3
## 4 evaluation fired -0.00212 0.01450237  evaluation=2
## 5     salary fired -0.16116 0.04892171      salary=2
...
## Confusion matrix:
##          fired   ok promoted class.error
## fired     2292  375      188   0.1971979
## ok         537 1248      436   0.4380910
## promoted   203  398     2170   0.2168892
\end{verbatim}
...
## 1 classification    1    fired      0.744 0.1210883       0.2577173
## 2 classification    1    fired      0.744 0.1210883       0.2577173
## 3 classification    1    fired      0.744 0.1210883       0.2577173
## 4 classification    1       ok      0.252 0.1357347       0.2117420
## 5 classification    1       ok      0.252 0.1357347       0.2117420
## 6 classification    1       ok      0.252 0.1357347       0.2117420
## 7 classification    1 promoted      0.004 0.2864840       0.5305676
## 8 classification    1 promoted      0.004 0.2864840       0.5305676
## 9 classification    1 promoted      0.004 0.2864840       0.5305676
##   model_prediction    feature feature_value feature_weight
## 1       0.61722434        age          57.7   -0.008805929
## 2       0.61722434      hours          42.3    0.248865720
## 3       0.61722434 evaluation           2.0    0.119447260
## 4       0.36348877        age          57.7    0.006871459
## 5       0.36348877 evaluation           2.0    0.212141203
## 6       0.36348877      hours          42.3   -0.067265930
## 7       0.01931097        age          57.7    0.001930615
## 8       0.01931097 evaluation           2.0   -0.331658381
## 9       0.01931097      hours          42.3   -0.181528821
##           feature_desc                      data          prediction
## 1           50.0 < age 2.0, 57.7, 42.3, 2.0, 2.0 0.744, 0.252, 0.004
## 2 37.6 < hours <= 46.3 2.0, 57.7, 42.3, 2.0, 2.0 0.744, 0.252, 0.004
## 3      evaluation <= 3 2.0, 57.7, 42.3, 2.0, 2.0 0.744, 0.252, 0.004
## 4           50.0 < age 2.0, 57.7, 42.3, 2.0, 2.0 0.744, 0.252, 0.004
## 5      evaluation <= 3 2.0, 57.7, 42.3, 2.0, 2.0 0.744, 0.252, 0.004
## 6 37.6 < hours <= 46.3 2.0, 57.7, 42.3, 2.0, 2.0 0.744, 0.252, 0.004
## 7           50.0 < age 2.0, 57.7, 42.3, 2.0, 2.0 0.744, 0.252, 0.004
## 8      evaluation <= 3 2.0, 57.7, 42.3, 2.0, 2.0 0.744, 0.252, 0.004
## 9 37.6 < hours <= 46.3 2.0, 57.7, 42.3, 2.0, 2.0 0.744, 0.252, 0.004
\end{verbatim}
...
## 1  0.060938977       1.0  0.06093898       male gender=male   gender=male
## 2  0.005270869      57.7  0.30412915       57.7         age      age=57.7
## 3 -0.090228194      42.3 -3.81665262       42.3       hours    hours=42.3
## 4 -0.513921982       2.0 -1.02784396          2  evaluation  evaluation=2
## 5 -0.032890479       2.0 -0.06578096          2      salary      salary=2
## 6 -0.010774607       1.0 -0.01077461       male gender=male   gender=male
##   .class
## 1  fired
## 2  fired
## 3  fired
...
\chapter{What-If analysis with the Ceteris Paribus
...
## 
##           Mean of squared residuals: 485483.4
##                     % Var explained: 40.89
\end{verbatim}
...
## 1                1920        5     142     8 3096.791 construction.year
## 1.1              1921        5     142     8 3122.493 construction.year
## 1.2              1922        5     142     8 3121.561 construction.year
## 1.3              1923        5     142     8 3092.827 construction.year
## 1.4              1923        5     142     8 3092.827 construction.year
## 1.5              1924        5     142     8 3083.920 construction.year
##     _ids_      _label_
## 1       1 randomForest
## 1.1     1 randomForest
## 1.2     1 randomForest
...
## 1              1965        5     142     8 2315.26 randomForest
\end{verbatim}
...
## 2           surface     1     662.0231
## 4          no.rooms     1     418.1700
## 3             floor     1     339.2508
## 1 construction.year     1     256.9103
\end{verbatim}
...
\section{Partial Dependency Plots}\label{partialDependence}}
...
\chapter{Performance Diagnostic}\label{modelComparisons}}

Model selection

\hypertarget{modelAuditing}{%
\chapter{Residual Diagnostic}\label{modelAuditing}}
...
Each row corresponds to a single employee from a call center. Features
...
three classes. But having a model we will use prediction level
