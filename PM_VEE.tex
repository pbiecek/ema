...
\NormalTok{similar <-}\StringTok{ }\KeywordTok{sample_locally2}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ HR,}
                           \DataTypeTok{explained_instance =}\NormalTok{ new_observation,}
                           \DataTypeTok{explained_var =} \StringTok{"status"}\NormalTok{,}
                           \DataTypeTok{method =} \StringTok{"lime"}\NormalTok{,}
...
\NormalTok{similar1 <-}\StringTok{ }\KeywordTok{add_predictions2}\NormalTok{(}\DataTypeTok{to_explain =}\NormalTok{ similar,}
                             \DataTypeTok{black_box_model =}\NormalTok{ rf_model, }
...
\NormalTok{HR_explanation <-}\StringTok{ }\KeywordTok{fit_explanation2}\NormalTok{(}\DataTypeTok{live_object =}\NormalTok{ similar1,}
                              \DataTypeTok{white_box =} \StringTok{"regr.glm"}\NormalTok{)}
\NormalTok{HR_explanation}

\KeywordTok{plot}\NormalTok{(HR_explanation, }\DataTypeTok{type =} \StringTok{"forest"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\textbf{The iml package}
