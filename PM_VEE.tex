...
{\centering \includegraphics[width=0.5\linewidth]{figure/modelLifetime} 
...
In section in which we work with larger number of models we use
...
## fired     2277  380      198   0.2024518
## ok         531 1243      447   0.4403422
## promoted   199  396     2176   0.2147239
\end{verbatim}
...
## Confusion matrix:
##          fired   ok promoted class.error
## fired     2275  379      201   0.2031524
## ok         534 1242      445   0.4407924
## promoted   204  383     2184   0.2118369
\end{verbatim}
...
## Predicted value: 0.798000, Average prediction: 0.376094 (diff = 0.421906) Predicted value: 0.200000, Average prediction: 0.273884 (diff = -0.073884) Predicted value: 0.002000, Average prediction: 0.350023 (diff = -0.348023)
## 
## Analysed predictor: 
...
## 1     gender fired  0.15600 0.09186570   gender=male
## 2        age fired  0.12082 0.08383548      age=57.7
## 3      hours fired  0.26154 0.10200605    hours=42.3
## 4 evaluation fired  0.03508 0.01745337  evaluation=2
## 5     salary fired -0.15776 0.04906184      salary=2
...
## Confusion matrix:
##          fired   ok promoted class.error
## fired     2284  377      194   0.2000000
## ok         533 1239      449   0.4421432
## promoted   209  387     2175   0.2150848
\end{verbatim}
...
## 1 classification    1    fired      0.802 0.1326693       0.2601045
## 2 classification    1    fired      0.802 0.1326693       0.2601045
## 3 classification    1    fired      0.802 0.1326693       0.2601045
## 4 classification    1       ok      0.198 0.1328936       0.2201385
## 5 classification    1       ok      0.198 0.1328936       0.2201385
## 6 classification    1       ok      0.198 0.1328936       0.2201385
## 7 classification    1 promoted      0.000 0.2663979       0.5158718
## 8 classification    1 promoted      0.000 0.2663979       0.5158718
## 9 classification    1 promoted      0.000 0.2663979       0.5158718
##   model_prediction    feature feature_value feature_weight
## 1      0.647513838     gender           2.0     0.01900717
## 2      0.647513838      hours          42.3     0.27104112
## 3      0.647513838 evaluation           2.0     0.09736102
## 4      0.340315741        age          57.7    -0.01174598
## 5      0.340315741 evaluation           2.0     0.20265622
## 6      0.340315741      hours          42.3    -0.07073304
## 7      0.002286556        age          57.7    -0.01355935
## 8      0.002286556 evaluation           2.0    -0.30029087
## 9      0.002286556      hours          42.3    -0.19973507
##           feature_desc                      data          prediction
## 1        gender = male 2.0, 57.7, 42.3, 2.0, 2.0 0.802, 0.198, 0.000
## 2 37.6 < hours <= 46.3 2.0, 57.7, 42.3, 2.0, 2.0 0.802, 0.198, 0.000
## 3      evaluation <= 3 2.0, 57.7, 42.3, 2.0, 2.0 0.802, 0.198, 0.000
## 4           50.0 < age 2.0, 57.7, 42.3, 2.0, 2.0 0.802, 0.198, 0.000
## 5      evaluation <= 3 2.0, 57.7, 42.3, 2.0, 2.0 0.802, 0.198, 0.000
## 6 37.6 < hours <= 46.3 2.0, 57.7, 42.3, 2.0, 2.0 0.802, 0.198, 0.000
## 7           50.0 < age 2.0, 57.7, 42.3, 2.0, 2.0 0.802, 0.198, 0.000
## 8      evaluation <= 3 2.0, 57.7, 42.3, 2.0, 2.0 0.802, 0.198, 0.000
## 9 37.6 < hours <= 46.3 2.0, 57.7, 42.3, 2.0, 2.0 0.802, 0.198, 0.000
\end{verbatim}
...
## 1  0.065049360       1.0  0.06504936       male gender=male   gender=male
## 2  0.005639541      57.7  0.32540150       57.7         age      age=57.7
## 3 -0.090095457      42.3 -3.81103781       42.3       hours    hours=42.3
## 4 -0.504226839       2.0 -1.00845368          2  evaluation  evaluation=2
## 5 -0.033152006       2.0 -0.06630401          2      salary      salary=2
## 6 -0.018448882       1.0 -0.01844888       male gender=male   gender=male
##   .class
## 1  fired
## 2  fired
## 3  fired
...
## 
##           Mean of squared residuals: 485220.9
##                     % Var explained: 40.92
\end{verbatim}
...
## 1                1920        5     142     8 3087.961 construction.year
## 1.1              1921        5     142     8 3113.750 construction.year
## 1.2              1922        5     142     8 3100.954 construction.year
## 1.3              1923        5     142     8 3072.724 construction.year
## 1.4              1923        5     142     8 3072.724 construction.year
## 1.5              1924        5     142     8 3086.026 construction.year
##     _ids_      _label_
## 1       1 randomForest
## 1.1     1 randomForest
## 1.2     1 randomForest
...
## 1              1965        5     142     8 2341.515 randomForest
\end{verbatim}
...
## 2           surface     1     645.4397
## 4          no.rooms     1     399.8738
## 3             floor     1     321.7802
## 1 construction.year     1     249.1199
\end{verbatim}
