...
## fired     2259  398      198   0.2087566
## ok         526 1239      456   0.4421432
## promoted   197  390     2184   0.2118369
\end{verbatim}
...
## Confusion matrix:
##          fired   ok promoted class.error
## fired     2276  384      195   0.2028021
## ok         536 1249      436   0.4376407
## promoted   189  398     2184   0.2118369
\end{verbatim}
...
## Predicted value: 0.794000, Average prediction: 0.375143 (diff = 0.418857) Predicted value: 0.204000, Average prediction: 0.275756 (diff = -0.071756) Predicted value: 0.002000, Average prediction: 0.349101 (diff = -0.347101)
## 
## Analysed predictor: 
...
## 1     gender fired  0.13008 0.09003256   gender=male
## 2        age fired  0.18560 0.06621430      age=57.7
## 3      hours fired  0.27256 0.11448211    hours=42.3
## 4 evaluation fired  0.02166 0.01519588  evaluation=2
## 5     salary fired -0.16164 0.04790096      salary=2
...
## Confusion matrix:
##          fired   ok promoted class.error
## fired     2283  376      196   0.2003503
## ok         530 1243      448   0.4403422
## promoted   205  385     2181   0.2129195
\end{verbatim}
...
## 1 classification    1    fired      0.800 0.1396411       0.2538017
## 2 classification    1    fired      0.800 0.1396411       0.2538017
## 3 classification    1    fired      0.800 0.1396411       0.2538017
## 4 classification    1       ok      0.196 0.1432531       0.2199446
## 5 classification    1       ok      0.196 0.1432531       0.2199446
## 6 classification    1       ok      0.196 0.1432531       0.2199446
## 7 classification    1 promoted      0.004 0.2958015       0.5302182
## 8 classification    1 promoted      0.004 0.2958015       0.5302182
## 9 classification    1 promoted      0.004 0.2958015       0.5302182
##   model_prediction    feature feature_value feature_weight
## 1        0.6337665        age          57.7   -0.010400836
## 2        0.6337665      hours          42.3    0.274371574
## 3        0.6337665 evaluation           2.0    0.115994024
## 4        0.3484818        age          57.7    0.002087662
## 5        0.3484818 evaluation           2.0    0.212595301
## 6        0.3484818      hours          42.3   -0.086145791
## 7        0.0105041     gender           2.0   -0.002908031
## 8        0.0105041 evaluation           2.0   -0.328662889
## 9        0.0105041      hours          42.3   -0.188143152
##           feature_desc                      data          prediction
## 1           50.0 < age 2.0, 57.7, 42.3, 2.0, 2.0 0.800, 0.196, 0.004
## 2 37.6 < hours <= 46.3 2.0, 57.7, 42.3, 2.0, 2.0 0.800, 0.196, 0.004
## 3      evaluation <= 3 2.0, 57.7, 42.3, 2.0, 2.0 0.800, 0.196, 0.004
## 4           50.0 < age 2.0, 57.7, 42.3, 2.0, 2.0 0.800, 0.196, 0.004
## 5      evaluation <= 3 2.0, 57.7, 42.3, 2.0, 2.0 0.800, 0.196, 0.004
## 6 37.6 < hours <= 46.3 2.0, 57.7, 42.3, 2.0, 2.0 0.800, 0.196, 0.004
## 7        gender = male 2.0, 57.7, 42.3, 2.0, 2.0 0.800, 0.196, 0.004
## 8      evaluation <= 3 2.0, 57.7, 42.3, 2.0, 2.0 0.800, 0.196, 0.004
## 9 37.6 < hours <= 46.3 2.0, 57.7, 42.3, 2.0, 2.0 0.800, 0.196, 0.004
\end{verbatim}
...
## 1  0.073398706       1.0  0.07339871       male gender=male   gender=male
## 2  0.005556429      57.7  0.32060598       57.7         age      age=57.7
## 3 -0.089888815      42.3 -3.80229688       42.3       hours    hours=42.3
## 4 -0.500369411       2.0 -1.00073882          2  evaluation  evaluation=2
## 5 -0.028623351       2.0 -0.05724670          2      salary      salary=2
## 6 -0.012760505       1.0 -0.01276050       male gender=male   gender=male
##   .class
## 1  fired
## 2  fired
## 3  fired
...
## 
##           Mean of squared residuals: 482861
##                     % Var explained: 41.21
\end{verbatim}
...
## 1                1920        5     142     8 3070.725 construction.year
## 1.1              1921        5     142     8 3093.451 construction.year
## 1.2              1922        5     142     8 3073.149 construction.year
## 1.3              1923        5     142     8 3057.999 construction.year
## 1.4              1923        5     142     8 3057.999 construction.year
## 1.5              1924        5     142     8 3084.691 construction.year
##     _ids_      _label_
## 1       1 randomForest
## 1.1     1 randomForest
## 1.2     1 randomForest
...
## 1              1965        5     142     8 2342.833 randomForest
\end{verbatim}
...
## 2           surface     1     631.9128
## 4          no.rooms     1     437.2496
## 3             floor     1     328.6568
## 1 construction.year     1     233.3454
\end{verbatim}
...
\chapter{Comparision of prediction level
