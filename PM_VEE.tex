...
## Confusion matrix:
##          fired   ok promoted class.error
## fired     2271  385      199   0.2045534
## ok         523 1251      447   0.4367402
## promoted   206  386     2179   0.2136413
\end{verbatim}
...
## Predicted value: 0.808000, Average prediction: 0.375389 (diff = 0.432611) Predicted value: 0.192000, Average prediction: 0.274949 (diff = -0.082949) Predicted value: 0.000000, Average prediction: 0.349662 (diff = -0.349662)
## 
## Analysed predictor: 
...
## 1     gender fired  0.10842 0.08645311   gender=male
## 2        age fired  0.15568 0.07170672      age=57.7
## 3      hours fired  0.29256 0.12155888    hours=42.3
## 4 evaluation fired  0.04130 0.01475130  evaluation=2
## 5     salary fired -0.12298 0.03181830      salary=2
...
## Confusion matrix:
##          fired   ok promoted class.error
## fired     2266  396      193   0.2063047
## ok         531 1242      448   0.4407924
...
## 1 classification    1    fired      0.794 0.1226009       0.2594139
## 2 classification    1    fired      0.794 0.1226009       0.2594139
## 3 classification    1    fired      0.794 0.1226009       0.2594139
## 4 classification    1       ok      0.204 0.1346355       0.1937033
## 5 classification    1       ok      0.204 0.1346355       0.1937033
## 6 classification    1       ok      0.204 0.1346355       0.1937033
## 7 classification    1 promoted      0.002 0.2874681       0.5194594
## 8 classification    1 promoted      0.002 0.2874681       0.5194594
## 9 classification    1 promoted      0.002 0.2874681       0.5194594
##   model_prediction    feature feature_value feature_weight
## 1       0.62140048        age          57.7    0.008945661
## 2       0.62140048      hours          42.3    0.253414722
## 3       0.62140048 evaluation           2.0    0.099626217
## 4       0.45484447        age          57.7   -0.016872504
## 5       0.45484447 evaluation           2.0    0.211620105
## 6       0.45484447     salary           2.0    0.066393522
## 7       0.01229047        age          57.7    0.008827847
## 8       0.01229047 evaluation           2.0   -0.310953560
## 9       0.01229047      hours          42.3   -0.205043261
##           feature_desc                      data          prediction
## 1           50.0 < age 2.0, 57.7, 42.3, 2.0, 2.0 0.794, 0.204, 0.002
## 2 37.6 < hours <= 46.3 2.0, 57.7, 42.3, 2.0, 2.0 0.794, 0.204, 0.002
## 3      evaluation <= 3 2.0, 57.7, 42.3, 2.0, 2.0 0.794, 0.204, 0.002
## 4           50.0 < age 2.0, 57.7, 42.3, 2.0, 2.0 0.794, 0.204, 0.002
## 5      evaluation <= 3 2.0, 57.7, 42.3, 2.0, 2.0 0.794, 0.204, 0.002
## 6      1 < salary <= 2 2.0, 57.7, 42.3, 2.0, 2.0 0.794, 0.204, 0.002
## 7           50.0 < age 2.0, 57.7, 42.3, 2.0, 2.0 0.794, 0.204, 0.002
## 8      evaluation <= 3 2.0, 57.7, 42.3, 2.0, 2.0 0.794, 0.204, 0.002
## 9 37.6 < hours <= 46.3 2.0, 57.7, 42.3, 2.0, 2.0 0.794, 0.204, 0.002
\end{verbatim}
...
## 1  0.073863766       1.0  0.07386377       male gender=male   gender=male
## 2  0.005603827      57.7  0.32334080       57.7         age      age=57.7
## 3 -0.090485678      42.3 -3.82754418       42.3       hours    hours=42.3
## 4 -0.506998868       2.0 -1.01399774          2  evaluation  evaluation=2
## 5 -0.034933988       2.0 -0.06986798          2      salary      salary=2
## 6 -0.018542541       1.0 -0.01854254       male gender=male   gender=male
##   .class
## 1  fired
## 2  fired
## 3  fired
...
## 
##           Mean of squared residuals: 486569.1
##                     % Var explained: 40.75
\end{verbatim}
...
## 1                1920        5     142     8 3135.026 construction.year
## 1.1              1921        5     142     8 3150.483 construction.year
## 1.2              1922        5     142     8 3145.264 construction.year
## 1.3              1923        5     142     8 3093.033 construction.year
## 1.4              1923        5     142     8 3093.033 construction.year
## 1.5              1924        5     142     8 3115.194 construction.year
##     _ids_      _label_
## 1       1 randomForest
## 1.1     1 randomForest
## 1.2     1 randomForest
...
## 1              1965        5     142     8 2302.849 randomForest
\end{verbatim}
...
## 2           surface     1     671.6376
## 4          no.rooms     1     464.6665
## 3             floor     1     345.2991
## 1 construction.year     1     259.6724
\end{verbatim}
