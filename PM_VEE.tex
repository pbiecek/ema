...
## fired     2272  383      200   0.2042032
## ok         531 1254      436   0.4353895
## promoted   199  388     2184   0.2118369
\end{verbatim}
...
## randomForest.fired: * evaluation = 2           0.057
## randomForest.fired: * salary = 2              -0.257
## randomForest.fired: * age = 58                 0.098
## randomForest.fired: * gender = male            0.285
## randomForest.fired: prediction                 0.796
## randomForest.ok: baseline                      0.276
## randomForest.ok: * hours = 42                 -0.049
## randomForest.ok: * evaluation = 2              0.096
## randomForest.ok: * salary = 2                  0.255
## randomForest.ok: * age = 58                   -0.092
## randomForest.ok: * gender = male              -0.285
...
## ok         528 1251      442   0.4367402
## promoted   207  392     2172   0.2161674
\end{verbatim}
...
## Predicted value: 0.792000, Average prediction: 0.376501 (diff = 0.415499) Predicted value: 0.208000, Average prediction: 0.274798 (diff = -0.066798) Predicted value: 0.000000, Average prediction: 0.348700 (diff = -0.348700)
## 
## Analysed predictor: 
...
## 1     gender fired  0.11518 0.06998684   gender=male
## 2        age fired  0.09168 0.05403505      age=57.7
## 3      hours fired  0.39130 0.11996391    hours=42.3
## 4 evaluation fired  0.03112 0.01266952  evaluation=2
## 5     salary fired -0.16776 0.05692447      salary=2
...
## 1 classification    1    fired      0.816 0.1293086       0.2634954
## 2 classification    1    fired      0.816 0.1293086       0.2634954
## 3 classification    1    fired      0.816 0.1293086       0.2634954
## 4 classification    1       ok      0.182 0.1364639       0.2159665
## 5 classification    1       ok      0.182 0.1364639       0.2159665
## 6 classification    1       ok      0.182 0.1364639       0.2159665
## 7 classification    1 promoted      0.002 0.2758085       0.5205572
## 8 classification    1 promoted      0.002 0.2758085       0.5205572
## 9 classification    1 promoted      0.002 0.2758085       0.5205572
##   model_prediction    feature feature_value feature_weight
## 1      0.641391257        age          57.7    0.009033602
## 2      0.641391257      hours          42.3    0.269037621
## 3      0.641391257 evaluation           2.0    0.099824658
## 4      0.348710626        age          57.7   -0.003164799
## 5      0.348710626 evaluation           2.0    0.211860498
## 6      0.348710626      hours          42.3   -0.075951574
## 7      0.009942181        age          57.7   -0.005864937
## 8      0.009942181 evaluation           2.0   -0.311753609
## 9      0.009942181      hours          42.3   -0.192996509
##           feature_desc                      data          prediction
## 1           50.0 < age 2.0, 57.7, 42.3, 2.0, 2.0 0.816, 0.182, 0.002
## 2 37.6 < hours <= 46.3 2.0, 57.7, 42.3, 2.0, 2.0 0.816, 0.182, 0.002
## 3      evaluation <= 3 2.0, 57.7, 42.3, 2.0, 2.0 0.816, 0.182, 0.002
## 4           50.0 < age 2.0, 57.7, 42.3, 2.0, 2.0 0.816, 0.182, 0.002
## 5      evaluation <= 3 2.0, 57.7, 42.3, 2.0, 2.0 0.816, 0.182, 0.002
## 6 37.6 < hours <= 46.3 2.0, 57.7, 42.3, 2.0, 2.0 0.816, 0.182, 0.002
## 7           50.0 < age 2.0, 57.7, 42.3, 2.0, 2.0 0.816, 0.182, 0.002
## 8      evaluation <= 3 2.0, 57.7, 42.3, 2.0, 2.0 0.816, 0.182, 0.002
## 9 37.6 < hours <= 46.3 2.0, 57.7, 42.3, 2.0, 2.0 0.816, 0.182, 0.002
\end{verbatim}
...
\includegraphics{PM_VEE_files/figure-latex/unnamed-chunk-26-2.pdf}
...
## 1  0.058094981       1.0  0.05809498       male gender=male   gender=male
## 2  0.004958897      57.7  0.28612836       57.7         age      age=57.7
## 3 -0.089340492      42.3 -3.77910282       42.3       hours    hours=42.3
## 4 -0.500562786       2.0 -1.00112557          2  evaluation  evaluation=2
## 5 -0.034414640       2.0 -0.06882928          2      salary      salary=2
## 6 -0.025139926       1.0 -0.02513993       male gender=male   gender=male
##   .class
## 1  fired
## 2  fired
## 3  fired
...
## 
##           Mean of squared residuals: 486892.1
##                     % Var explained: 40.71
\end{verbatim}
...
## 1                1920        5     142     8 3077.724 construction.year
## 1.1              1921        5     142     8 3103.306 construction.year
## 1.2              1922        5     142     8 3104.387 construction.year
## 1.3              1923        5     142     8 3062.239 construction.year
## 1.4              1923        5     142     8 3062.239 construction.year
## 1.5              1924        5     142     8 3070.310 construction.year
##     _ids_      _label_
## 1       1 randomForest
## 1.1     1 randomForest
## 1.2     1 randomForest
...
## 1              1965        5     142     8 2305.159 randomForest
\end{verbatim}
...
## 2           surface     1     638.8438
## 4          no.rooms     1     473.4043
## 3             floor     1     352.2330
## 1 construction.year     1     256.6445
\end{verbatim}
