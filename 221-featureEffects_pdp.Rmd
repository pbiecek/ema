...
pdp_rf <- partial_dependency(explain_titanic_rf, selected_passangers)
...
plot(cp_rf, color = "grey") +
  show_aggreagated_profiles(clust_rf, size = 2, color = "_label_") +
...
pdp_gender_rf <- aggregate_profiles(cp_rf, selected_variables = "age",
				groups = "gender")

plot(cp_rf, color = "grey", selected_variables = "age") +
  show_aggreagated_profiles(pdp_gender_rf, color = "_label_", size = 2) +
