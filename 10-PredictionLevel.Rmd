...
```{r cutsSurfaceReady, echo=FALSE, fig.cap="(fig:cutsSurfaceReady) Model response surface. We are interested in understanding the model behavior in a single point x*", out.width = '60%'}
knitr::include_graphics("figure/cuts_surface_ready_punkt.png")
```

```{r cutsTechnikiReady, echo=FALSE, fig.cap="(fig:cutsTechnikiReady) Panel A presents an idea behind ceteris paribus profiles, panel B presents an idea behind LIME, panel C presents an idea behind variable attribution", out.width = '99%'}
