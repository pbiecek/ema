# Instance-level exploration {#InstanceLevelExploration}


```{r localDALEXsummary, echo=FALSE, fig.cap="(fig:localDALEXsummary) Summary of differnet approaches to local model exploration and explanation.", out.width = '99%', fig.align='center'}
knitr::include_graphics("figure/cheatsheet_local_explainers.png")
```
