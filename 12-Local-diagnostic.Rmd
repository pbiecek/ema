...
```{r residualDistributionFidelityPlot, warning=FALSE, message=FALSE, eval=TRUE, fig.width=7, fig.height=2, out.width = '70%', fig.align='center'}
...
The function `residuals_distribution()` can be also used for a local stability plot as in Figure \@ref(fig:localFidelityPlots). To do this we need to also specify an `variables` argument.
