...
explain_rf_v6 <- explain(explain_rf_v6$model, data = explain_rf_v6$data,
        y = explain_rf_v6$y)
...
```{r titanicCeterisParibus08, warning=FALSE, message=FALSE, fig.width=7, fig.height=2, out.width = '70%', fig.align='center'}
