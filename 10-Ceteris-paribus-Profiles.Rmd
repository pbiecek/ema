...
[Przemek] TODO: make sure that this is johny d
...
TODO [Przemek] make sure that this is for johny d
...
In this section, we present key features of the R package `ingredients` [@ingredientsRPackage] which is a part of `DrWhy.AI` universe and covers all methods presented in this chapter. 
