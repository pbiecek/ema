...
```{r profileAgeRf, echo=FALSE, fig.cap="Ceteris-paribus profiles for variable `age` for the logistic regression (`titanic_lmr_v6`) and random forest (`titanic_rf_v6` ) models that predict the probability of surviving based on the Titanic data. Black dot corresponds to the passenger `johny_d`.", out.width = '70%', fig.align='center'}
...
```{r titanicCeterisProfile01D, warning=FALSE, message=FALSE, fig.width=7, fig.height=4, fig.cap="Ceteris-paribus profiles for the `titanic_rf_v6` model. Profiles for different passengers are color-coded.", out.width = '70%', fig.align='center'}
library(ingredients)
