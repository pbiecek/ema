...
You can place ceteris-paribus profiles for several models on a single chart. Simply add them as further arguments for the `plot` function. See an example below. The resulting plot is shown in Figure \@ref(fig:cpPython4).  
