...
# "34e1919c02771be1b54b452641d28a6c"
...
|--------------|-----------------|------------|-----------------|
| `titanic_lmr_v6`  | `rms:: lmr` v.5.1.3  | gender, age, class, sibsp, parch, fare, embarked |  Get the model: `archivist:: aread("pbiecek/models/56d8a")`. Get the explainer: `archivist:: aread("pbiecek/models/34e19")` |
