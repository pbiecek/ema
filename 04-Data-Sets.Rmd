...
Each adapter contains all elements needed to create a model explanation, i.e., a suitable `predict()` function, validation data set, and the model object. Thus, to keep code snippets more concise, in subsequent chapters we will use the explainers instead of the model objects. 
