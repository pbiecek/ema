...
ggplot(data = apartments) +
   ...
   labs(x="Price per meter-squared", title='Histogram for apartments prices per m2') + theme_drwhy() + theme(legend.position = "none") 
```
...
pa1 <- ggplot(data = apartments, aes(construction.year, m2.price)) +
  ...
  geom_smooth(se = FALSE, size=1, color = "#371ea3") +
   labs(y="Price per meter-squared", x = "Construction year", title='Apartment price per m2 vs. construction year') + theme_drwhy() + theme(legend.position = "none") 

pa2 <- ggplot(data = apartments, aes(surface, m2.price)) +
   geom_point(size = 0.3) +
  geom_smooth(se = FALSE, size=1, color = "#371ea3") +
   labs(y="Price per meter-squared", x = "Surface (meter-squared)", title='Apartment price per m2 vs. surface') + theme_drwhy() + theme(legend.position = "none") 
