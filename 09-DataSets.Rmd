...
See Figures \@ref(fig:HRExplorationAge)-\@ref(fig:HRExplorationEvaluation) for some exploratory analysis.

Young female and old male are being fired more frequently.

```{r HRExplorationAge, warning=FALSE, message=FALSE, echo=FALSE, fig.width=6, fig.height=4, fig.cap="HR status for age groups and gender.", out.width = '70%', fig.align='center'}
...
```{r HRExplorationSalary, warning=FALSE, message=FALSE, echo=FALSE, fig.width=6, fig.height=4, fig.cap="HR status for salary groups.", out.width = '70%', fig.align='center'}
ggplot(data = HR) +
...
```{r HRExplorationEvaluation, warning=FALSE, message=FALSE, echo=FALSE, fig.width=6, fig.height=4, fig.cap="HR status for evaluation groups.", out.width = '70%', fig.align='center'}
ggplot(data = HR) +
...
As in previous chapters, we will see how to use models that we have just created.
As s test case we will use a single employee of the call center, let's name him Dilbert.

Dilbert is a male few years before 60. Working around 40h per week, poor evaluation and average salary.
What are his chances for promotion or survival? 
...
predict(HR_rf_v5, dilbert, type = "prob")

predict(HR_glm_v5, dilbert, type = "prob")
```

As you see, they are not that high. It's likely that Dilbert will be fired in the next year. But why? We will try to answer this question in  next chapters.
