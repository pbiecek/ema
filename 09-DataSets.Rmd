...
```{r titanic_exploration_gender, warning=FALSE, message=FALSE, echo=FALSE, fig.width=6, fig.height=4, fig.cap="(fig:titanic_exploration_gender) .", out.width = '70%', fig.align='center'}
library("ggmosaic")
ggplot(data = titanic) +
