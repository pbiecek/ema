...
```{r titanicExplorationCountry, warning=FALSE, message=FALSE, echo=FALSE, fig.width=6, fig.height=4, fig.cap="Survival for different countries in the titanic data.", out.width = '70%', fig.align='center'}
ggplot(data = titanic) +
...
```{r titanicExplorationFare, warning=FALSE, message=FALSE, echo=FALSE, fig.cap="Survival as a function of fare in the titanic data.", fig.width=6, fig.height=2, echo=FALSE, out.width = '70%', fig.align='center'}
library("ggplot2")
