...
```{r appartments_mi2_construction, warning=FALSE, message=FALSE, echo=FALSE, fig.width=4, fig.height=4, fig.cap="(fig:appartments_mi2_construction) Relation between construction year and price per sq meter"}
...
```{r appartments_mi2_surface, warning=FALSE, message=FALSE, echo=FALSE, fig.width=4, fig.height=4, fig.cap="(fig:appartments_mi2_surface) Relation between surface and price per sq meter"}
...
```{r appartments_mi2_floor, warning=FALSE, message=FALSE, echo=FALSE, fig.width=4, fig.height=4, fig.cap="(fig:appartments_mi2_floor) Relation between floor and price per sq meter"}
...
```{r appartments_mi2_norooms, warning=FALSE, message=FALSE, echo=FALSE, fig.width=4, fig.height=4, fig.cap="(fig:appartments_mi2_norooms) Relation between no rooms and price per sq meter"}
...
```{r appartments_surface_norooms, warning=FALSE, message=FALSE, echo=FALSE, fig.width=4, fig.height=4, fig.cap="(fig:appartments_surface_norooms) Relation between no rooms and surface"}
...
```{r appartments_mi2_district, warning=FALSE, message=FALSE, echo=FALSE, fig.width=6, fig.height=4, fig.cap="(fig:appartments_mi2_district) Relation between district and price per sq meter"}
...
ggplot(data = HR) +
   ...
   labs(x="Gender", y="Promoted of fired?", title='Promoted of fired?') + theme_drwhy() + theme(legend.position = "none") + coord_flip() + scale_fill_manual(values = theme_drwhy_colors(3))
```
...
ggplot(data = HR) +
   ...
   labs(x="Salary", y="Promoted of fired?", title='Promoted of fired?') + theme_drwhy() + theme(legend.position = "none") + coord_flip() + scale_fill_manual(values = theme_drwhy_colors(3))
```
...
ggplot(data = HR) +
   ...
   labs(x="Evaluation", y="Promoted of fired?", title='Promoted of fired?') + theme_drwhy() + theme(legend.position = "none") + coord_flip() + scale_fill_manual(values = theme_drwhy_colors(3))
```
