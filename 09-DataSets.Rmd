...
### Linear regression {#modelApartmentslr}
...
### Random forest {#modelApartmentsrf}
...
In Sections \@ref(modelApartmentslr) and \@ref(modelApartmentsrf) we have built two predictive models for the `apartments` data set. The models will be used in the rest of the book to illustrate the model explanation methods and tools. 
...
### Multinomial logistic regression {#modelHRmr}
...
In Sections \@ref(modelHRmr) and \@ref(modelHRrf) we have built two predictive models for the `HR` data set. The models will be used in the remainder of the book to illustrate model-explanation methods and tools. 
