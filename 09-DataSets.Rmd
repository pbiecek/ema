...
```{r save_models, warning=FALSE, message=FALSE }
link_to_amodels <- "models/models_apartments.rda"

if (!file.exists(link_to_amodels)) {
   save(model_HR_rf, model_HR_glm, 
       model_apartments_lm, model_apartments_rf, 
       file = link_to_models)
}
```