...
Table: (\#tab:shapOrderingTable) SHAP values for the prediction for `johny_d` for the random-forest model `titanic_rf_v6` and the Titanic data for 25 random orderings. [TOMASZ: JOHNY_d FROM BELFAST IN CHAP. 4?]
