...
preprocess = make_column_transformer(
    (OneHotEncoder(), ['gender', 'class', 'embarked']), remainder="passthrough")
...
exp = dx.Explainer(model, X, y, label = "Titanic RF Pipeline")
...
bd_john = exp.predict_parts(henry, type='break_down')
bd_john
bd_john.plot()
```
