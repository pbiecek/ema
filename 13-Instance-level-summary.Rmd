...
(ref:instanceLevelExplainersDesc) Results of instance-level-explanation techniques for the random-forest model `titanic_rf_v6` for the Titanic data and Johnny D. [TOMASZ: STATI FIGURE. CHECK IF CORRECT.]
...
[TOMASZ: I THINK WE LACK AN OVERALL CONCLUSON FOR THE COMPARATIVE ANALYSIS. WHICH OF THE FOUR MODELS SEEMS TO BE THE BEST/REASONABLE? WHERE DOES THE DIFFERENCE IN THE PREDICTED PROBABILITY OF SURVIVAL COME FROM?]
