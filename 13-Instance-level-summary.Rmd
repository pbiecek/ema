...
* model studio for `titanic_rf_v4` model https://titanic-rf-v4.netlify.com
* model studio for `titanic_rf_v6` model https://titanic-rf-v6.netlify.com
* model studio for `titanic_gbm_v6` model https://titanic-gbm-v6.netlify.com
* model studio for `titanic_lmr_v6` model https://titanic-lmr-v6.netlify.com


```{r titanicRfV6ModelStudio, echo=FALSE, fig.cap="Example view of modelStudio for titanic-rf-v6 model.", out.width = '95%', fig.align='center'}
knitr::include_graphics("figure/titanic_rf_v6.png")
```
