...
```{r CPVIP1, echo=FALSE, fig.cap="Variable-importance measures calculated for Ceteris-paribus oscillations for `johny_d` based on the `titanic_rf_v6` model", out.width = '65%', fig.align='center', fig.width=8, fig.height=5.5}
...
oscillations_titanic_rf <- variable_attribution(explain_rf_v6, henry, type = "oscillations")
