...
Note that glass-box models, like the decision tree presented in Figure \@ref(fig:BILLCD8) easily satisfies explainability laws introduced in Section \@ref(three-single-laws).
...
* For many more advanced models with an additive structure, like the proportional hazards model, many tools can be used for checking model assumptions, see for example [@rms].
...
* BERT family of models leads to high-performance models in Natural Language Processing. The exBEAT method [@hoover2019exbert] is designed to visualize the activation of attention heads in this model.
