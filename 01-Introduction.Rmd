...
-	**Prediction's validation**. For every prediction of a model, one should be able to verify how strong is the evidence that supports the prediction.
...
We would like to thank everyone who contributed with feedback, found typos, or ignited discussions while the book was being written, including GitHub contributors: Rees Morrison, [Alicja Gosiewska](https://github.com/agosiewska/),  [Kasia Pekala](https://github.com/kasiapekala/), [Hubert Baniecki](https://github.com/hbaniecki/), [Asia Henzel](https://github.com/AsiaHenzel/), [Anna Kozak](https://github.com/kozaka93/),
[Agile Bean](https://github.com/agilebean/). We would like to acknowledge the anonymous reviewers, whose comments helped us to improve the contents of the book. We are grateful to John Kimmel from Chapman & Hall/CRC Press for his editorial assistance and patience.
