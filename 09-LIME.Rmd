...
plot_interpretable_feature(lime_johnny, "age") + ggtitle("Interpretable representation for age","" ) + 
  xlab("age") + ylab("model response") + theme_ema
```
