...
```{r, warning=FALSE, message=FALSE, eval=TRUE}
library("localModel")
local_model_rf <- individual_surrogate_model(x = explain_titanic_rf, 
...
localModel_lok <- individual_surrogate_model(explain_rf, johnny_d,
                                        size = 5000, seed = 1313)
localModel_lok
...
```{r, warning=FALSE, message=FALSE, eval=TRUE}
library("iml")
iml_rf <- Predictor$new(model = titanic_rf, data = titanic_imputed[,colnames(johnny_d)])
