...
The first term on the right-hand-side of equation \@ref(eq:EPE) is the variability of $Y$ around its conditional expected value $f(\underline{\theta};\underline{x}_*)$. In general, it cannot be reduced. The second term is the squared 
