...
pl2 <- ggplot(fifa19small, aes(Value.EUR)) +
  ...
  ggtitle("Histogram for player's value","")  + theme_ema
...
ggplot(fifa19small4long, aes(value)) +
  geom_histogram() + 
  theme_drwhy() + facet_wrap(~variable, ncol = 2, scales = "free") + ggtitle("Histograms for player's characteristics","") + scale_x_continuous("") + theme_ema
```
...
ggplot(fifa19small4long, aes(value, Value.EUR)) +
  ...
  scale_x_continuous("") + 
  ggtitle("Scatterplots for player's characteristics","") + theme_ema
...
ggpairs(fifa19small4v[,-1], 
  ...
  theme_drwhy() + 
   ggtitle("Scatterplot matrix for player's characteristics","") + theme_ema
...
plot(fifa_md_gbm_shallow, fifa_md_gbm_deep, fifa_md_rf, fifa_md_rm, 
  ...
  ggtitle("Predicted and observed player's values", "") + theme_ema
```
