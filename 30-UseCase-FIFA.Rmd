...
The `model_diagnostics()` function (see Section \@ref(RcodeResidualDiagnostic)) is used to create residual-diagnostics plots. Results of this function can be visualised with the generic `plot()` function. In the code below, additional arguments are used to improve the outlook and interpretability of both axes.
...
fifa_mp_gbm.plot(variables = ['movement_reactions', 'skill_ball_control', 
    'skill_dribbling', 'age'])
```
