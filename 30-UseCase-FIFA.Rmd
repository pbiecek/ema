...
```{r distFIFA19scatter, warning=FALSE, message=FALSE, echo=FALSE, fig.width=8, fig.height=6.5, fig.cap="(fig:distFIFA19scatter) Scatterplot for relation between selected four players characteristics and values of players.", out.width = '90%', fig.align='center'}
...
```{r featureImportance, warning=FALSE, message=FALSE, echo=TRUE, fig.width=10, fig.height=8, fig.cap="Variable importance plots for four considered models. Each bar starts in a RMSE for the model and ends in a RMSE calculated for data with permuted single variable.", out.width = '90%', fig.align='center'}
library("ingredients")
