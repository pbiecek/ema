...
Better understanding of a model or its predictions has many applications. Here we summarise how different roles can use model explainers.
...
Developer perspective:
  ...
  Detect flaws in the model/data
...
User perspective:
  ...
  More acceptable in some applications
  
  
  Lear from the learning machine
  
  Improving models
  
  Legislation and the right to explanations
