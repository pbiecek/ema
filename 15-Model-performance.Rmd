...
A variant of ROC curve based on precision and recall is a called a precision-recall curve. Figure \@ref(fig:examplePRC) the curve for the random forest model for the Titanic dataset. 
...
Table: (\#tab:confMatRF) Confusion table for the random forest model for the Titanic data. Predicted survival status is equal to TRUE if the model-predicted probability of survival $\hat y_i$ is larger than 50\%. 
...
Figure \@ref(fig:examplePRC) presents the precision-recall curve for the random forest model. 
...
The resulting object can be visualised in many different ways. Let's start wit ROC curve with AUC measure. Figure \@ref(fig:examplePythonMP4) presents the created plot.
...
(ref:examplePythonMP4Desc) The ROC plot for the random forest model for the Titanic dataset.  

```{r examplePythonMP4, echo=FALSE, out.width = '80%', fig.cap='(ref:examplePythonMP4Desc)'}
knitr::include_graphics("figure/python_model_performance_4.png")
```

Next plot will show FP and TP rates as a function of different thresholds. Figure \@ref(fig:examplePythonMP3) presents the created plot.
...
(ref:examplePythonMP3Desc) The FRP/TPR as a function of threshold for the random forest model for the Titanic dataset.  

```{r examplePythonMP3, echo=FALSE, out.width = '100%', fig.align='center', fig.cap='(ref:examplePythonMP3Desc)'}
