...
```{r titanicROC, warning=FALSE, message=FALSE, echo=FALSE, fig.width=5, fig.height=5, fig.cap="ROC curves for the  random-forest model and the logistic regression model for the Titanic dataset.", fig.align='center'}
library("DALEX")
library("randomForest")
...
```{r titanicLift, warning=FALSE, message=FALSE, echo=FALSE, fig.width=5, fig.height=5, fig.cap="Lift curves for the  random-forest model and the logistic regression model for the Titanic dataset.", fig.align='center'}
plot(eva_rf, eva_lr, geom = "lift")
```

```{r titanicGain, warning=FALSE, message=FALSE, echo=FALSE, fig.width=5, fig.height=5, fig.cap="Cumulative gain chart for the  random-forest model and the logistic regression model for the Titanic dataset.", fig.align='center'}
