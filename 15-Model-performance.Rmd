...
```{r titanicGain, warning=FALSE, message=FALSE, echo=FALSE, fig.width=5, fig.height=5, fig.cap="Cumulative gain chart for the  random-forest model and the logistic regression model for the Titanic dataset."}
