...
# Model's Performance {#modelPerformance}
...
Both plot functions return `ggplot2` objects and both can take one or more explanations as arguments. In the latter case profiles for each explanation will be superimposed in a plot. 

```{r titanicROCexamples,fig.cap="(fig:titanicROCexamples) ROC and LIFT curves for two models for Titanic dataset.",  warning=FALSE, message=FALSE, fig.width=5, fig.height=5}
plot_roc(eva_rf, eva_lr)
plot_lift(eva_rf, eva_lr)
```
