...
# plot results
explain_titanic_rf <- explain(explain_titanic_rf$model, explain_titanic_rf$data, y = explain_titanic_rf$y, type = "classification")
explain_titanic_lr <- explain(explain_titanic_lmr$model, explain_titanic_lmr$data, y = explain_titanic_lmr$y, type = "classification")
...
In this section, we present the key features of the `DALEX` R package which is a part of the [DrWhy.AI](http://DrWhy.AI) universe. The package covers all methods presented in this chapter. Please note that more advanced measures of performance are avalivable in the `auditor` R package [@auditor].
