...
(ref:ibdPython2Desc) Break-down plot with interactions for the random-forest model and Henry for the Titanic data, obtained by applying the `plot()` method in Python. [TOMASZ: CHERBOURG]
