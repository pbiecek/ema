...
\KeywordTok{library}\NormalTok{(}\StringTok{"DALEX"}\NormalTok{)}
\NormalTok{explain_rf_v6 <-}\StringTok{ }\NormalTok{archivist}\OperatorTok{::}\KeywordTok{aread}\NormalTok{(}\StringTok{"pbiecek/models/9b971"}\NormalTok{)}
\CommentTok{# recreate object to have predict function}
\NormalTok{explain_rf_v6 <-}\StringTok{ }\KeywordTok{explain}\NormalTok{(explain_rf_v6}\OperatorTok{$}\NormalTok{model,}
                         \DataTypeTok{data =}\NormalTok{ explain_rf_v6}\OperatorTok{$}\NormalTok{data,}
                         \DataTypeTok{y =}\NormalTok{ explain_rf_v6}\OperatorTok{$}\NormalTok{y,}
...
\includegraphics{ema_files/figure-latex/unnamed-chunk-66-1.pdf}
...
\includegraphics{ema_files/figure-latex/unnamed-chunk-69-1.pdf}
