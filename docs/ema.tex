...
{\centering \includegraphics[width=0.7\linewidth]{ema_files/figure-latex/unnamed-chunk-26-1} 
...
\{\centering \includegraphics[width=0.7\linewidth]{ema_files/figure-latex/iBreakDownTitanicExamplePlot-1}
...
{\centering \includegraphics[width=0.7\linewidth]{ema_files/figure-latex/iBDforHenry-1} 
...
\begin{center}\includegraphics[width=0.5\linewidth]{ema_files/figure-latex/unnamed-chunk-37-1} \end{center}
...
\NormalTok{local_model_rf <-}\StringTok{ }\KeywordTok{individual_surrogate_model}\NormalTok{(explainer_titanic_rf, johny_d,}
...
\textbackslash{}caption\{LIME-method results for the prediction for \texttt{johny\_d} for the random-forest model \texttt{titanic\_rf\_v6} and the Titanic data, generated by the \texttt{localModel} package. \}\label{fig:limeExplLocalModelTitanic}
\textbackslash{}end\{figure\}
...
\StringTok{  }\KeywordTok{scale_color_manual}\NormalTok{(}\DataTypeTok{name =} \StringTok{"Passenger:"}\NormalTok{, }\DataTypeTok{breaks =} \DecValTok{1}\OperatorTok{:}\DecValTok{2}\NormalTok{, }
            \DataTypeTok{values =} \KeywordTok{c}\NormalTok{(}\StringTok{"#4378bf"}\NormalTok{, }\StringTok{"#8bdcbe"}\NormalTok{), }\DataTypeTok{labels =} \KeywordTok{c}\NormalTok{(}\StringTok{"henry"}\NormalTok{ , }\StringTok{"johny_d"}\NormalTok{)) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{ggtitle}\NormalTok{(}\StringTok{"Ceteris Paribus profile"}\NormalTok{, }
            \StringTok{"For the random forest model and the titanic dataset"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{center}\includegraphics[width=0.7\linewidth]{ema_files/figure-latex/titanicCeterisParibus05-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{ema_files/figure-latex/titanicCeterisParibus07-1} \end{center}
...
{\centering \includegraphics[width=0.8\linewidth]{ema_files/figure-latex/championChallengerCP-1} 
...
\addcontentsline{toc}{section}{Dataset Level}
...
\begin{figure}
\centering
\includegraphics{ema_files/figure-latex/titanicROC-1.pdf}
...
\begin{figure}
\centering
\includegraphics{ema_files/figure-latex/titanicLift-1.pdf}
...
\includegraphics{ema_files/figure-latex/titanicMEexamples-1.pdf}
...
\includegraphics{ema_files/figure-latex/titanicMEexamples-2.pdf}
...
\begin{figure}
\centering
\includegraphics{ema_files/figure-latex/titanicBoxplots-1.pdf}
...
\begin{figure}
\centering
\includegraphics{ema_files/figure-latex/titanic3-1.pdf}
...
\begin{figure}
\centering
\includegraphics{ema_files/figure-latex/titanic4-1.pdf}
...
\begin{figure}
\centering
\includegraphics{ema_files/figure-latex/titanic5-1.pdf}
...
\includegraphics{ema_files/figure-latex/unnamed-chunk-67-1.pdf}
...
\includegraphics{ema_files/figure-latex/unnamed-chunk-70-1.pdf}
...
\subsubsection{Partial Dependency Profiles}\label{partial-dependency-profiles}}
...
{\centering \includegraphics{ema_files/figure-latex/plotPrediction2-1} 
...
{\centering \includegraphics{ema_files/figure-latex/plotAutocorrelation1-1} 
...
Before we can explore model behavior we need to create explainers with the \texttt{DALEX::explain} function. These explainers will be later used to asses model performance.
...
{\centering \includegraphics[width=0.8\linewidth]{ema_files/figure-latex/modelPerformanceScatterplot-1} 
...
{\centering \includegraphics[width=0.7\linewidth]{ema_files/figure-latex/usecaseFIFAbreakDown-1} 
...
{\centering \includegraphics[width=0.7\linewidth]{ema_files/figure-latex/usecaseFIFAshap-1} 
...
{\centering \includegraphics[width=0.7\linewidth]{ema_files/figure-latex/usecaseFIFAbreakDownWS-1} 
