...
## 
##         OOB estimate of  error rate: 27.14%
## Confusion matrix:
##          fired   ok promoted class.error
## fired     2275  383      197   0.2031524
## ok         531 1254      436   0.4353895
## promoted   197  386     2188   0.2103934
\end{verbatim}
...
## randomForest.fired: * age = 58                 0.096
## randomForest.fired: * gender = male            0.282
...
## Confusion matrix:
##          fired   ok promoted class.error
## fired     2278  380      197   0.2021016
## ok         528 1258      435   0.4335885
...
## randomForest.fired: prediction                       0.810
## randomForest.ok: baseline                            0.276
## randomForest.ok: * evaluation = 2                    0.135
## randomForest.ok: * salary = 2                        0.157
## randomForest.ok: * age:gender = 58:male             -0.295
## randomForest.ok: * hours = 42                       -0.087
...
degenerated performance. Thus the early dectection of concept drift is
...
The most general formulation of a concept drift refers to chnges in
joint distribution of \(p(X, y)\). It is usefull to define also
following measires.
...
each variable separately despite of it's type. We do not rely on any
...
Two sample - train two elastic moels and compare them pdp by pdp
