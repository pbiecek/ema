...
\NormalTok{explainer_titanic_rf <-}\StringTok{ }\KeywordTok{explain}\NormalTok{(model_titanic_rf, }\DataTypeTok{data =}\NormalTok{ titanic_small, }\DataTypeTok{y =}\NormalTok{ titanic_small}\OperatorTok{$}\NormalTok{Survived)}
\end{Highlighting}
\end{Shaded}
...
## 1        1 male 0.42     0     0   72        C     Age     1  0.376
## 1.1      1 male 1.00     0     0   72        C     Age     1  0.388
## 1.2      1 male 2.00     0     0   72        C     Age     1  0.394
## 1.3      1 male 3.00     0     0   72        C     Age     1  0.386
## 1.4      1 male 4.00     0     0   72        C     Age     1  0.396
## 1.5      1 male 5.00     0     0   72        C     Age     1  0.394
##            _label_
## 1   randomForest.0
## 1.1 randomForest.0
## 1.2 randomForest.0
...
## 1        1 male   8     0     0   72        C   0.43 randomForest.0     1
## 1.1      1 male   8     0     0   72        C   0.57 randomForest.1     1
\end{verbatim}
...
## 1     Age     1   0.10958730
## 4   SibSp     1   0.08142857
## 2    Fare     1   0.07695000
## 3  Pclass     1   0.07000000
\end{verbatim}
...
## fired     2264  390      201   0.2070053
## ok         529 1248      444   0.4380910
## promoted   198  384     2189   0.2100325
\end{verbatim}
...
## randomForest.fired: hours = 42               0.241
## randomForest.fired: evaluation = 2           0.055
## randomForest.fired: salary = 2              -0.257
## randomForest.fired: age = 58                 0.119
## randomForest.fired: gender = male            0.273
## randomForest.fired: prediction               0.806
## randomForest.ok: intercept                   0.276
## randomForest.ok: hours = 42                 -0.052
## randomForest.ok: evaluation = 2              0.100
## randomForest.ok: salary = 2                  0.256
## randomForest.ok: age = 58                   -0.114
## randomForest.ok: gender = male              -0.274
## randomForest.ok: prediction                  0.192
...
## Confusion matrix:
##          fired   ok promoted class.error
## fired     2273  380      202   0.2038529
## ok         536 1247      438   0.4385412
## promoted   203  387     2181   0.2129195
\end{verbatim}
...
\begin{verbatim}
##                                       contribution
## randomForest.fired: intercept                0.818
## randomForest.fired: salary = 2              -0.330
## randomForest.fired: age = 58                 0.402
## randomForest.fired: evaluation = 2          -0.060
## randomForest.fired: hours = 42              -0.034
## randomForest.fired: gender = male            0.000
## randomForest.fired: prediction               0.796
## randomForest.ok: intercept                   0.998
## randomForest.ok: salary = 2                 -0.654
## randomForest.ok: hours:age = 42:58          -0.106
## randomForest.ok: gender = male               0.558
## randomForest.ok: evaluation = 2              0.000
## randomForest.ok: prediction                  0.202
## randomForest.promoted: intercept             0.996
## randomForest.promoted: salary = 2           -0.538
## randomForest.promoted: evaluation = 2       -0.340
## randomForest.promoted: age = 58              0.818
## randomForest.promoted: hours = 42           -0.140
...
\includegraphics{PM_VEE_files/figure-latex/unnamed-chunk-42-1.pdf}
...
\includegraphics{PM_VEE_files/figure-latex/unnamed-chunk-53-2.pdf}
...
\hypertarget{localProfiles}{%
\section{Local Dependency Profiles}\label{localProfiles}}
...
\hypertarget{conditional-marginal-profiles}{%
\subsection{Conditional / Marginal
Profiles}\label{conditional-marginal-profiles}}
