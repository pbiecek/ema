...
\CommentTok{# tapply(titanic$fare, titanic$class, mean, na.rm = TRUE)}
...
\{\centering \includegraphics[width=0.7\linewidth]{PM_VEE_files/figure-latex/titanic_exploration_gender-1}
...
\{\centering \includegraphics[width=0.7\linewidth]{PM_VEE_files/figure-latex/titanic_exploration_age-1}
...
\{\centering \includegraphics[width=0.7\linewidth]{PM_VEE_files/figure-latex/titanic_exploration_parch-1}
...
\{\centering \includegraphics[width=0.7\linewidth]{PM_VEE_files/figure-latex/titanic_exploration_sibsp-1}
...
\{\centering \includegraphics[width=0.7\linewidth]{PM_VEE_files/figure-latex/titanic_exploration_class-1}
...
## Confusion matrix:
##       no yes class.error
## no  1359 137  0.09157754
## yes  328 383  0.46132208
\end{verbatim}
...
As a result, we obtain the predicted probabilities of 0.33 and 0.42,
respectively.
...
Note that this is artificial dataset created to explain some differences
between random forest and linear regression. So the data is more clean
than a usual dataset. Nerveless let do some exploration.

Distribution of square meter is slightly skewed.

\begin{figure}
\centering
\includegraphics{PM_VEE_files/figure-latex/appartments_exploration_mi2-1.pdf}
\caption{(\#fig:appartments\_exploration\_mi2)(fig:appartments\_exploration\_mi2)
Survival for different countries in the titanic data.}
\end{figure}

There is some nonlinear (if any) relation between construction year and
price.

\begin{figure}
\centering
\includegraphics{PM_VEE_files/figure-latex/appartments_mi2_construction-1.pdf}
\caption{(\#fig:appartments\_mi2\_construction)(fig:appartments\_mi2\_construction)
Construction year vs price per sq meter}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{PM_VEE_files/figure-latex/appartments_mi2_surface-1.pdf}
\caption{(\#fig:appartments\_mi2\_surface)(fig:appartments\_mi2\_surface)
Surface vs price per sq meter}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{PM_VEE_files/figure-latex/appartments_mi2_floor-1.pdf}
\caption{(\#fig:appartments\_mi2\_floor)(fig:appartments\_mi2\_floor)
Floor vs price per sq meter}
\end{figure}

There is a close to linear relation between no of rooms and price. But
please note that surface and number of rooms are correlated.

\begin{figure}
\centering
\includegraphics{PM_VEE_files/figure-latex/appartments_mi2_norooms-1.pdf}
\caption{(\#fig:appartments\_mi2\_norooms)(fig:appartments\_mi2\_norooms)
No rooms vs price per sq meter}
\end{figure}

\begin{figure}
\centering
\includegraphics{PM_VEE_files/figure-latex/appartments_surface_norooms-1.pdf}
\caption{(\#fig:appartments\_surface\_norooms)(fig:appartments\_surface\_norooms)
No rooms vs surface}
\end{figure}

Prices are different in different districts. Highest are in the
Downtown.

\begin{figure}
\centering
\includegraphics{PM_VEE_files/figure-latex/appartments_mi2_district-1.pdf}
\caption{(\#fig:appartments\_mi2\_district)(fig:appartments\_mi2\_district)
District vs price per sq meter}
\end{figure}
...
difference is equal to 795.3. It is only minimally smaller than the
value of 283.1, obtained for the linear regression model. Thus, the
question we may face is: should we choose the model complex, but
flexible random-forest model, or the simpler and easier to interpret
linear model? In the subsequent chapters we will try to provide an
...
\{\centering \includegraphics[width=0.7\linewidth]{PM_VEE_files/figure-latex/HR_exploration_age-1}

\}

\textbackslash{}caption\{(fig:HR\_exploration\_age) HR status for age
groups and gender.\}(\#fig:HR\_exploration\_age)
\textbackslash{}end\{figure\}

\textbackslash{}begin\{figure\}

\{\centering \includegraphics[width=0.7\linewidth]{PM_VEE_files/figure-latex/HR_exploration_salary-1}

\}

\textbackslash{}caption\{(fig:HR\_exploration\_salary) HR status for
salary groups.\}(\#fig:HR\_exploration\_salary)
\textbackslash{}end\{figure\}

\textbackslash{}begin\{figure\}

\{\centering \includegraphics[width=0.7\linewidth]{PM_VEE_files/figure-latex/HR_exploration_evaluation-1}

\}

\textbackslash{}caption\{(fig:HR\_exploration\_evaluation) HR status for
evaluation groups.\}(\#fig:HR\_exploration\_evaluation)
\textbackslash{}end\{figure\}
...
approach.We chose this model to have a complex model that is smooth in
contrary to random forest that relies on binary splits for continuous
variables. We treat all variables other than \texttt{status} in the
\texttt{HR} data frame as explanatory and include them in the model. The
...
\section{Variable attribution with interactions}\label{iBreakDown}}
...
\begin{verbatim}
##   gender      age    hours evaluation salary   status age_cat
## 1   male 32.58267 41.88626          3      1    fired (20,40]
## 2 female 41.21104 36.34339          2      5    fired (40,60]
## 3   male 37.70516 36.81718          3      0    fired (20,40]
## 4 female 30.06051 38.96032          3      2    fired (20,40]
## 5   male 21.10283 62.15464          5      3 promoted (20,40]
## 6   male 40.11812 69.53973          2      0    fired (40,60]
##       age_gender
## 1   male (20,40]
## 2 female (40,60]
## 3   male (20,40]
...
## Confusion matrix:
##          fired   ok promoted class.error
## fired     2269  387      199   0.2052539
## ok         530 1251      440   0.4367402
## promoted   196  394     2181   0.2129195
\end{verbatim}
...
## 1 classification    1    fired      0.784 0.1270477       0.2612806
## 2 classification    1    fired      0.784 0.1270477       0.2612806
## 3 classification    1    fired      0.784 0.1270477       0.2612806
## 4 classification    1       ok      0.214 0.1276736       0.2127034
## 5 classification    1       ok      0.214 0.1276736       0.2127034
## 6 classification    1       ok      0.214 0.1276736       0.2127034
## 7 classification    1 promoted      0.002 0.2884252       0.5279373
## 8 classification    1 promoted      0.002 0.2884252       0.5279373
## 9 classification    1 promoted      0.002 0.2884252       0.5279373
##   model_prediction    feature feature_value feature_weight
## 1      0.627245626        age          57.7  -0.0012451888
## 2      0.627245626      hours          42.3   0.2572479945
## 3      0.627245626 evaluation           2.0   0.1099622667
## 4      0.367029831        age          57.7  -0.0006019132
## 5      0.367029831 evaluation           2.0   0.2066226123
## 6      0.367029831      hours          42.3  -0.0516942229
## 7      0.003383539     gender           2.0  -0.0023760345
## 8      0.003383539 evaluation           2.0  -0.3166349392
## 9      0.003383539      hours          42.3  -0.2055427677
##           feature_desc                      data          prediction
## 1           50.0 < age 2.0, 57.7, 42.3, 2.0, 2.0 0.784, 0.214, 0.002
...
## 6 37.6 < hours <= 46.3 2.0, 57.7, 42.3, 2.0, 2.0 0.784, 0.214, 0.002
## 7        gender = male 2.0, 57.7, 42.3, 2.0, 2.0 0.784, 0.214, 0.002
