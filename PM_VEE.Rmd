...
# Sequential Additive Attributions {#breakDown}
...
# Sequential attributions with interactions
...
# Average Additive Attributions {#shapley}
...
The dataset is available in the `DALEX` package [@R-DALEX]. Each row corresponds to a single employee from a call center. Features like gender, age, average number of working hours per week, grade from the last evaluation and level of salary are used as predictive features.
