...
They rarther compare model prediction agains average model prediction.

The complementary approach would be to directly explore infromation about model curvature around point of interest.
...
The most known paper related to local approximations is *Why Should I Trust You?: Explaining the Predictions of Any Classifier* [@lime]. This methods and it's clones are now implemented in variouse R and python packages, see for example [@R-lime] or [@R-live].
