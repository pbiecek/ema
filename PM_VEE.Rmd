...
lot: yes
lof: yes
description: "This book introduces key concepts for exploration, explanation and visualization of complex predictive models."
...
```{r localDALEXsummary, echo=FALSE, fig.cap="(fig:localDALEXsummary) Summary of three approached to local model exploration and explanation.", out.width = '99%', fig.align='center'}
...
# Sequential variable attributions {#breakDown}
...
# Sequential variable attribution with interactions
