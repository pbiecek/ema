...
```{r BDhenryExample, warning=FALSE, message=FALSE,  fig.cap="Generic plot() function for the BreakDown method calculated for `henry`.", out.width = '70%', fig.align='center', fig.width=8, fig.height=5}
plot(bd_rf) 
```
