...
. 
```{r, warning=FALSE, message=FALSE,  fig.cap="Generic plot() function for the break down method.", out.width = '70%', fig.align='center', fig.width=8, fig.height=5.5}
plot(bd_rf) 
```
