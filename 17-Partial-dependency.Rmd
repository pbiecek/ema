...
```{r pdp_part_1, warning=FALSE, message=FALSE, echo=FALSE, fig.width=8, fig.height=5, fig.cap="Ceteris Paribus profiles for 100 observations, the age variable and the random forest model", fig.align='center'}
library("ingredients")
...
```{r pdp_part_2, warning=FALSE, message=FALSE, echo=FALSE, fig.width=8, fig.height=5, fig.cap="Partial Dependency profile as an average for 100 observations", fig.align='center'}
...
```{r pdp_part_4, warning=FALSE, message=FALSE, echo=FALSE, fig.width=8, fig.height=5, fig.cap="Three cluster of 100 CP profiles", fig.align='center'}
library("ingredients")
...
```{r pdp_part_5, warning=FALSE, message=FALSE, echo=FALSE, fig.width=8, fig.height=5, fig.cap="Grouped profiles with respect to the gender variable", fig.align='center'}
cp_rf <- ceteris_paribus(explain_titanic_rf, selected_passangers)
...
```{r pdp_part_7, warning=FALSE, message=FALSE, echo=FALSE, fig.width=8, fig.height=5, fig.cap="Comparison on two predictive models with different structures.", fig.align='center'}
