...
pl2 <- plot(pdp_rf, geom = "aggregates_profiles") +
  scale_y_continuous(limits=c(0,1)) +
...
pdp_rf <- variable_profile(explain_titanic_rf, 
                           variables = "age",
                           k = 3)
plot(pdp_rf, geom = "aggregates_profiles") +
...
plot(pd_rf, variables = c("construction.year", "surface"), geom = "aggregates_profiles") + 
...
plot(pdp_sex_rf, geom = "aggregates_profiles") +
  ggtitle("Clustered Partial Dependency profiles.") 
```
