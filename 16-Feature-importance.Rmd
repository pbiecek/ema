...
mp_rf.result
```
```{r examplePythonFIM1, echo=FALSE, out.width = '50%'}
knitr::include_graphics("figure/python_model_parts_2.png")
```

The obtained results can be visualised by using the `plot()` method. Results are presented in figure \@ref(examplePythonFIM2).
