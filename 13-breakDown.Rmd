...
Variable attribution methods introduced in section \@ref(VAlinMod) works for additive models. But for many popular machine learning models we cannot assume that they are additive. 

In this section we introduce a model agnostic approach to variable attribution. Note that even if the model itself is not additive, the model attribution will be additive.
