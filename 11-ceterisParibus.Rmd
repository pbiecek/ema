...
In this section we introduce more formally one-dimensional CP profiles. <!-- We consider the case of a continuous dependent variable, but the profiles can be easily generalized for other types. -->
...
```{r titanicCeterisProfile01, warning=FALSE, message=FALSE, echo=FALSE, fig.width=7, fig.height=4, fig.cap="Ceteris-paribus profiles for the `titanic_rf_v6` model.", out.width = '70%', fig.align='center'}
library("ggplot2")
plot(cp_titanic_rf) +
