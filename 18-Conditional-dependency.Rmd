...
There are several attempts to fix this problem. Here we introduce Local Dependency Profiles presented in the  [@ALEPlotRPackage] under the name M-profiles.
...
## Example: Titanic data {#CDPExample}
...
As it is justified in [@ALEPlotRPackage], there is a serious problem with this approach, illustrated by a following observation. If $y$ depends on $x_2$ but not $x_1$
...
## Pros and cons {#CDPProsCons}

[TOMASZ: TO POPULATE]

## Code snippets for R {#CDPR}
